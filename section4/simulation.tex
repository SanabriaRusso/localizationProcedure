...
% In the case of the execution of Bounding-Box, as Beacon density increases more nodes are matched to execute Lateration, especially in the Free Space model. This results in a decreasing average of the error for Bounding-Box given that nodes matched to Lateration return a zero in the field of Bounding-Box associated error.
